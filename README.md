...
2026-09-08 기준 로컬 장비와 `lg_aimers_9th` Conda 환경에서 확인한 사양입니다.

| 항목 | 사양 |
|---|---|
| OS | Ubuntu 24.04.4 LTS · x86_64 |
| CPU | Intel Core i7-14700K · 20코어 / 28스레드 |
| RAM | 약 15GiB (OS 인식 용량) |
| GPU | NVIDIA GeForce RTX 4070 Ti SUPER · VRAM 16GB |
| NVIDIA 드라이버 | 580.173.02 |
| Python | 3.11.15 |
| PyTorch | 2.7.1 · CUDA 12.6 빌드 |
| cuDNN | 9.5.1 |
